...
public class WaitableCondPQ<E> {
    private final ReentrantLock lock = new ReentrantLock();
    private final Queue<E> priorityQueue;
    private final Condition cond = lock.newCondition();

    public WaitableCondPQ() {
        this(Integer.MAX_VALUE);
    }

    public WaitableCondPQ(int capacity) {
        priorityQueue = new PriorityQueue<>();
    }

    public WaitableCondPQ(Comparator<? super E> comparator) {
        this(Integer.MAX_VALUE, comparator);
    }

    public WaitableCondPQ(int capacity, Comparator<? super E> comparator) {
